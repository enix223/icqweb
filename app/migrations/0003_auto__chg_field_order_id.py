...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.id'
        db.alter_column(u'app_order', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Order.id'
        db.alter_column(u'app_order', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
    ...
    models = {
        u'app.order': {
            ...
            'order_status': ('django.db.models.fields.SmallIntegerField', [], {}),
        ...
        u'app.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'passwd': ('django.db.models.fields.CharField', [], {'default': "u'CsnNOcshoX'", 'max_length': '10'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {
