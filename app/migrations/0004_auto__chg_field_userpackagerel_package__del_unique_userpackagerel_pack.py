...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserPackageRel', fields ['package']
        db.delete_unique(u'app_userpackagerel', ['package_id'])


        # Changing field 'UserPackageRel.package'
        db.alter_column(u'app_userpackagerel', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Package']))

    def backwards(self, orm):

        # Changing field 'UserPackageRel.package'
        db.alter_column(u'app_userpackagerel', 'package_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['app.Package'], unique=True))
        # Adding unique constraint on 'UserPackageRel', fields ['package']
        db.create_unique(u'app_userpackagerel', ['package_id'])
    ...
    models = {
        u'app.order': {
            ...
            'order_status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Package']"}),
        ...
        u'app.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'passwd': ('django.db.models.fields.CharField', [], {'default': "u'SrKTcG'", 'max_length': '10'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {
