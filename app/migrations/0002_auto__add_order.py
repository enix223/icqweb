...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Order'
        db.create_table(u'app_order', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Package'])),
            ('order_status', self.gf('django.db.models.fields.SmallIntegerField')()),
    ...
    models = {
        ...
        u'app.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'passwd': ('django.db.models.fields.CharField', [], {'default': "u'mhcUdLRRoh'", 'max_length': '10'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'auth.group': {
